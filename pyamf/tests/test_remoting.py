...
class DecoderTestCase(unittest.TestCase):
    ...
    def test_string_reference_with_string_headers(self):
        msg = remoting.decode('\x00\x03\x00\x01\x00\x0b\x43\x72\x65\x64\x65\x6e\x74\x69\x61\x6c'
        ...
        self.assertEquals(len(msg.headers), 1)
        self.assertEquals(msg.headers['Credentials'], {'password': 'gggg', 'userid':'genopro\\@gerard'})
        self.assertEquals(len(msg), 1)
        self.assertTrue('/1' in msg)
