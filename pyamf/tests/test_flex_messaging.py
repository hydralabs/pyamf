...
class EncodingTestCase(unittest.TestCase):
    ...
    def test_AcknowledgeMessage(self):
        ...
        self.assertEqual(
            ...
            b'\n\x81\x0bUflex.messaging.messages.AcknowledgeMessage\tbody\x11cl'
            b'ientId\x1bcorrelationId\x17destination\x0fheaders\x13messageId'
            b'\x15timeToLive\x13timestamp\x01\x01\x06\t1234\x01\n\x0b\x01\x01'
            b'\x01\x01\x01\x01'
        )
    ...
    def test_ErrorMessage(self):
        ...
        self.assertEqual(
            ...
            b'\x1bcorrelationId\x17destination\x19extendedData\x13faultCode\x17'
            b'faultDetail\x17faultString\x0fheaders\x13messageId\x13rootCause'
            b'\x15timeToLive\x13timestamp\x01\x01\x01\x01\n\x0b\x01\x01\x01\x01'
            b'\x06\x15ValueError\n\x05\x01\x01\n\x05\x01\x01\x01\x01'
        )
